...
if __name__ == '__main__':
    ...
    if countTime == -1:
        ...
        time.sleep(60)
    print('刷课期间请保持网络通畅，脚本可在后台默默运行，可放心去进行您的其他工作。')
    print("刷课初始化中...")
    ...
    for course in courseList:
        print(course.course,course.isFinished)
        if course.isFinished == '已完成':
            continue
        for i in range((int)(course.videoLength) - (int)(course.lookTime)):
            frameUrl = f"http://www.gaoxiaokaoshi.com/Study/LibraryStudy.aspx?tmp=1&Id={course.courseId}&PlanId=11"
